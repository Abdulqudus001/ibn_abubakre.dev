      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div class="flex flex-wrap">
          <g-link to="/" class="mr-10 no-underline">
            <g-image src="../../static/logo.jpg" class="w-10 rounded-full" alt="logo" />
          </g-link>
          <ul
    ...
    <footer class="bg-background-tertiary text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:me@abdulqudusabubakre@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/abdulqudus001" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/ibn_abubakre" target="_blank" class="text-white hover:text-gray-400">
