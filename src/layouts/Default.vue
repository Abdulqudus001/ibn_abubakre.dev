    ...
    <footer class="bg-background-primary text-copy-primary">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:me@abdulqudusabubakre@gmail.com" class="text-copy-primary hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/abdulqudus001" target="_blank" class="text-copy-primary hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/ibn_abubakre" target="_blank" class="text-copy-primary hover:text-gray-400">
